...
if sys.platform == "darwin":
    ...
    define_macros.extend([("WIN32_LEAN_AND_MEAN", None), ("_WIN32_WINNT", "0x0601"), ("BZ_EXPORT", None)])
...
class CustomBuildExtCommand(_build_ext):
    ...
    def build_extension(self, ext: Extension):
        ...
        def _compile(
            obj: str, src: str, ext: str, cc_args: list, extra_postargs: list, pp_opts: list
        ):
            original_compile(
                obj,
                src,
                ...
                for file in files:
                    if self.include_file(os.path.join(root, file)):
                        ...
                        if root.startswith(
                            ...
                            for name in ["Ice", "IceSSL", "IceDiscovery", "IceLocatorDiscovery"]:
