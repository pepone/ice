...
class OutgoingConnectionFactory
{
    ...
    waitUntilFinished()
    {
        this._waitPromise = new IcePromise();
        this.checkFinished();
    ...
    create(endpts, hasMore, selType)
    {
        ...
        try
        {
            ...
            if(connection !== null)
            {
                return IcePromise.resolve(connection);
            }
        }
        catch(ex)
        {
            return IcePromise.reject(ex);
        }
...
export { OutgoingConnectionFactory };
