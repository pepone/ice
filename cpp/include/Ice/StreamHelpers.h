 ...
 */
    ...
    {
        static const StreamHelperCategory helper =
            IsMap<T>::value ? StreamHelperCategoryDictionary :
     ...
     * \headerfile Ice/Ice.h
     */
    template<> struct StreamableTraits<UserException>
    {
        static const StreamHelperCategory helper = StreamHelperCategoryUserException;
     ...
     * \headerfile Ice/Ice.h
     */
    template<typename T, typename U> struct StreamableTraits<::std::pair<T, U>>
    {
        static const StreamHelperCategory helper = StreamHelperCategorySequence;
        static const int minWireSize = 1;
        static const bool fixedLength = false;
     ...
     * \headerfile Ice/Ice.h
     */
    template<> struct StreamableTraits<Byte>
    {
        static const StreamHelperCategory helper = StreamHelperCategoryBuiltin;
        static const int minWireSize = 1;
        static const bool fixedLength = true;
     ...
     * \headerfile Ice/Ice.h
     */
    template<> struct StreamableTraits<Short>
    {
        static const StreamHelperCategory helper = StreamHelperCategoryBuiltin;
     ...
     * \headerfile Ice/Ice.h
     */
    template<> struct StreamableTraits<Int>
    {
        static const StreamHelperCategory helper = StreamHelperCategoryBuiltin;
     ...
     * \headerfile Ice/Ice.h
     */
    template<> struct StreamableTraits<Long>
    {
        static const StreamHelperCategory helper = StreamHelperCategoryBuiltin;
 ...
 */
    ...
    struct StreamableTraits<::std::shared_ptr<T>,
                            typename ::std::enable_if<::std::is_base_of<::Ice::ObjectPrx, T>::value>::type>
    {
...
#else
    template<typename T> struct StreamableTraits<::IceInternal::ProxyHandle<T>>
    {
        static const StreamHelperCategory helper = StreamHelperCategoryProxy;
        static const int minWireSize = 2;
        static const bool fixedLength = false;
 ...
 */
...
#else
    template<typename T> struct StreamableTraits<::IceInternal::Handle<T>>
    {
        static const StreamHelperCategory helper = StreamHelperCategoryClass;
        static const int minWireSize = 1;
        static const bool fixedLength = false;
     ...
     * \headerfile Ice/Ice.h
     */
    template<typename T> struct StreamHelper<T, StreamHelperCategoryStructClass>
    {
        template<class S> static inline void write(S* stream, const T& v)
        {
            StreamWriter<T, S>::write(stream, v);
    ...
    template<typename T> struct StreamHelper<T, StreamHelperCategoryEnum>
    {
        template<class S> static inline void write(S* stream, const T& v)
        {
            if(static_cast<Int>(v) < StreamableTraits<T>::minValue ||
    ...
    template<typename T> struct StreamHelper<std::pair<const T*, const T*>, StreamHelperCategorySequence>
    {
        ...
        template<class S> static inline void read(S* stream, std::pair<const T*, const T*>& v)
        {
            stream->read(v);
        }
    };
    ...
    {
        template<class S> static inline void write(S* stream, const std::pair<T, T>& v)
        {
        ...
        template<class S> static inline void read(S* stream, std::pair<T, T>& v)
        {
            stream->read(v);
        }
    };
     ...
     */
    template<>
    struct StreamHelper<std::pair<::std::vector<bool>::const_iterator, ::std::vector<bool>::const_iterator>,
                        StreamHelperCategorySequence>
    {
        template<class S>
        static inline void
        write(S* stream, const std::pair<::std::vector<bool>::const_iterator, ::std::vector<bool>::const_iterator>& v)
        {
            stream->writeSize(static_cast<Int>(IceUtilInternal::distance(v.first, v.second)));
    ...
    {
        template<class S>
        static inline void read(S* stream, std::pair<IceUtil::ScopedArray<T>, std::pair<const T*, const T*>>& v)
        {
     ...
     * \headerfile Ice/Ice.h
     */
    template<> struct GetOptionalFormat<StreamHelperCategoryBuiltin, 1, true>
    {
     ...
     * \headerfile Ice/Ice.h
     */
    template<> struct GetOptionalFormat<StreamHelperCategoryBuiltin, 2, true>
    {
     ...
     * \headerfile Ice/Ice.h
     */
    template<> struct GetOptionalFormat<StreamHelperCategoryBuiltin, 4, true>
    {
     ...
     * \headerfile Ice/Ice.h
     */
    template<> struct GetOptionalFormat<StreamHelperCategoryBuiltin, 8, true>
    {
    ...
    struct StreamOptionalHelper<T, StreamHelperCategoryStructClass, fixedLength>
        : StreamOptionalHelper<T, StreamHelperCategoryStruct, fixedLength>
    {
    };
     ...
     */
    template<typename T>
    struct StreamOptionalHelper<T, StreamHelperCategoryProxy, false>
        : StreamOptionalHelper<T, StreamHelperCategoryStruct, false>
    {
    };
    ...
    template<typename T, int sz> struct StreamOptionalContainerHelper<T, false, sz>
    {
        ...
        template<class S> static inline void write(S* stream, const T& v, Int)
        {
    ...
    template<typename T, int sz> struct StreamOptionalContainerHelper<T, true, sz>
    {
        ...
        template<class S> static inline void write(S* stream, const T& v, Int n)
        {
            //
     ...
     * \headerfile Ice/Ice.h
     */
    template<typename T> struct StreamOptionalHelper<std::pair<T, T>, StreamHelperCategorySequence, false>
    {
