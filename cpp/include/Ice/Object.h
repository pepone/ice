...
namespace Ice
{
    ...
    public:
         ...
         */
        virtual bool ice_dispatch(Ice::Request& request, std::function<bool()> response = nullptr,
    ...
    public:
        ...
        /// \cond INTERNAL
        virtual bool _iceGcVisit(IceInternal::GCVisitor&)
        {
            return false;
        }
        /// \endcond
    ...
    public:
        ...
        virtual void ice_invokeAsync(std::vector<Byte> inEncaps,
                                     ...
                                     std::function<void(std::exception_ptr)> error, const Current& current) = 0;
#else
        /**
         * Dispatch an incoming request asynchronously.
         *
    ...
    public:
        ...
        virtual void ice_invoke_async(const AMD_Object_ice_invokePtr& cb,
                                      const std::pair<const Byte*, const Byte*>& inEncaps, const Current& current) = 0;
#endif
