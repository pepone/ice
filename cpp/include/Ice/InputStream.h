...
namespace Ice
{
    ...
    /// \cond INTERNAL
    template<typename T> inline void patchHandle(void* addr, const ValuePtr& v)
    {
    ...
    public:
        ...
        //
        IceInternal::Instance* instance() const
        {
            return _instance;
        } // Inlined for performance reasons.
        /// \endcond
         ...
         */
        template<typename T> void readAll(std::initializer_list<int> tags, IceUtil::Optional<T>& v)
        {
