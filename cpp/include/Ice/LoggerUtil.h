...
namespace Ice
{
    ...
    {
        static inline LoggerOutputBase& insert(LoggerOutputBase& out, const T& ex)
        {
    ...
    inline LoggerOutputBase& operator<<(LoggerOutputBase& os, const ::std::shared_ptr<T>& p)
#else
    template<typename T>
    inline LoggerOutputBase& operator<<(LoggerOutputBase& os, const ::IceInternal::ProxyHandle<T>& p)
#endif
    {
