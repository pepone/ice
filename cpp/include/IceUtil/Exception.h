...
namespace IceUtil
{
    ...
    template<typename E> class ExceptionHelper : public Exception
    {
    public:
        ExceptionHelper()
        {
    ...
    template<typename E> class SyscallExceptionHelper : public SyscallException
    {
    public:
        SyscallExceptionHelper(const char* file, int line, int errorCode) : SyscallException(file, line, errorCode)
        {
        }
