...
// supports sparc (32 and 64 bit).
    ...
    ((defined(__sun) && (defined(__sparc) || defined(__sparcv9))) || defined(__APPLE__) ||                             \
     (defined(__linux) && (defined(__i486) || defined(__i586) || defined(__i686) || defined(__x86_64))))
...
#    endif
    ...
    public:
        ...
        Atomic(int desired) : _ref(desired)
        {
        }
