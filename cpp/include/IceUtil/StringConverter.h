...
namespace IceUtil
{
     ...
     */
    ICE_API std::string wstringToString(const std::wstring& str, const StringConverterPtr& nc = 0,
     ...
     */
    ICE_API std::wstring stringToWstring(const std::string& str, const StringConverterPtr& nc = 0,
                                         const WstringConverterPtr& wc = 0);
