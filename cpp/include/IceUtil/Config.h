...
#elif defined(__i386) || defined(_M_IX86) || defined(__x86_64) || defined(_M_X64) || defined(_M_IA64) ||               \
    defined(__alpha__) || defined(__ARMEL__) || defined(_M_ARM_FP) || defined(__arm64) || defined(__MIPSEL__)

#    define ICE_LITTLE_ENDIAN

#elif defined(__sparc) || defined(__sparc__) || defined(__hppa) || defined(__ppc__) || defined(__powerpc) ||           \
    defined(_ARCH_COM) || defined(__MIPSEB__)
...
#        define ICE_32
#    elif defined(__sun) && (defined(__sparcv9) || defined(__x86_64)) || defined(__linux) && defined(__x86_64) ||      \
