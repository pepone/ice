...
namespace IceUtilInternal
{
    ...
    template<class R, class T, class H> class MemFun : public std::unary_function<H, R>
    {
    ...
    template<class R, class T, class H, class A> class MemFun1 : public std::binary_function<H, A, R>
    {
    ...
    template<class T, class H> class VoidMemFun : public std::unary_function<H, void>
    {
    ...
    template<class T, class H, class A> class VoidMemFun1 : public std::binary_function<H, A, void>
    {
    ...
    template<class R, class K, class T, class H> class SecondMemFun : public std::unary_function<std::pair<K, H>, R>
    {
        typedef R (T::*MemberFN)(void);
        MemberFN _mfn;
    ...
    template<class K, class T, class H> class SecondVoidMemFun : public std::unary_function<std::pair<K, H>, void>
    {
        typedef void (T::*MemberFN)(void);
        MemberFN _mfn;
    ...
    template<class R, class T, class H> class ConstMemFun : public std::unary_function<H, R>
    {
    ...
    template<class R, class T, class H, class A> class ConstMemFun1 : public std::binary_function<H, A, R>
    {
    ...
    template<class T, class H> class ConstVoidMemFun : public std::unary_function<H, void>
    {
    ...
    template<class T, class H, class A> class ConstVoidMemFun1 : public std::binary_function<H, A, void>
    {
    ...
    template<class K, class T, class H> class SecondConstVoidMemFun : public std::unary_function<std::pair<K, H>, void>
    {
        typedef void (T::*MemberFN)(void) const;
        MemberFN _mfn;
...
namespace IceUtil
{
    template<class R, class T> inline ::IceUtilInternal::MemFun<R, T, Handle<T>> memFun(R (T::*p)(void))
    {
        return ::IceUtilInternal::MemFun<R, T, Handle<T>>(p);
    }

    template<class R, class T, class A> inline ::IceUtilInternal::MemFun1<R, T, Handle<T>, A> memFun1(R (T::*p)(A))
    {
        return ::IceUtilInternal::MemFun1<R, T, Handle<T>, A>(p);
    }

    template<class T> inline ::IceUtilInternal::VoidMemFun<T, Handle<T>> voidMemFun(void (T::*p)(void))
    {
        return ::IceUtilInternal::VoidMemFun<T, Handle<T>>(p);
    }

    template<class T, class A> inline ::IceUtilInternal::VoidMemFun1<T, Handle<T>, A> voidMemFun1(void (T::*p)(A))
    {
    ...
    template<class R, class T> inline ::IceUtilInternal::ConstMemFun<R, T, Handle<T>> constMemFun(R (T::*p)(void) const)
    {
    ...
    template<class T> inline ::IceUtilInternal::ConstVoidMemFun<T, Handle<T>> constVoidMemFun(void (T::*p)(void) const)
    {
