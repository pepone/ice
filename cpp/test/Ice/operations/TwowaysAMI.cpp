...
namespace
{
    ...
    public:
        ...
        void opShortIntLongS(const Test::LongS& rso, const Test::ShortS& sso, const Test::IntS& iso,
        ...
        void opShortIntLongSS(const Test::LongSS& rso, const Test::ShortSS& sso, const Test::IntSS& iso,
...
function<void(exception_ptr)> makeExceptionClosure(CallbackPtr& cb)
{
...
void twowaysAMI(const Ice::CommunicatorPtr& communicator, const Test::MyClassPrxPtr& p)
{
    {
        ...
        Ice::Callback_Object_ice_pingPtr callback =
            Ice::newCallback_Object_ice_ping(cb, &Callback::ping, &Callback::exCB);
...

    {
        CallbackPtr cb = ICE_MAKE_SHARED(Callback);
#ifdef ICE_CPP11_MAPPING
        p->ice_isAAsync(Test::MyClass::ice_staticId(), [&](bool v) { cb->isA(v); }, makeExceptionClosure(cb));
#else
        Ice::Callback_Object_ice_isAPtr callback = Ice::newCallback_Object_ice_isA(cb, &Callback::isA, &Callback::exCB);
...

    {
        CallbackPtr cb = ICE_MAKE_SHARED(Callback);
#ifdef ICE_CPP11_MAPPING
        p->ice_idAsync([&](string id) { cb->id(move(id)); }, makeExceptionClosure(cb));
#else
        Ice::Callback_Object_ice_idPtr callback = Ice::newCallback_Object_ice_id(cb, &Callback::id, &Callback::exCB);
...

    {
        CallbackPtr cb = ICE_MAKE_SHARED(Callback);
#ifdef ICE_CPP11_MAPPING
        p->ice_idsAsync([&](vector<string> ids) { cb->ids(move(ids)); }, makeExceptionClosure(cb));

#else
        Ice::Callback_Object_ice_idsPtr callback = Ice::newCallback_Object_ice_ids(cb, &Callback::ids, &Callback::exCB);
...

    {
        CallbackPtr cb = ICE_MAKE_SHARED(Callback);
#ifdef ICE_CPP11_MAPPING
        p->opByteAsync(Ice::Byte(0xff), Ice::Byte(0x0f), [&](Ice::Byte b1, Ice::Byte b2) { cb->opByte(b1, b2); },
                       makeExceptionClosure(cb));
#else
        Test::Callback_MyClass_opBytePtr callback =
            Test::newCallback_MyClass_opByte(cb, &Callback::opByte, &Callback::exCB);
...
#else
        Test::Callback_MyClass_opBoolPtr callback =
            Test::newCallback_MyClass_opBool(cb, &Callback::opBool, &Callback::exCB);
...

    {
        ...
        p->opShortIntLongAsync(
            10, 11, 12,
            [&](long long int l1, short s1, int i1, long long int l2) { cb->opShortIntLong(l1, s1, i1, l2); },
            makeExceptionClosure(cb));
#else
...

    {
        CallbackPtr cb = ICE_MAKE_SHARED(Callback);
#ifdef ICE_CPP11_MAPPING
        p->opFloatDoubleAsync(3.14f, 1.1E10, [&](double d1, float f1, double d2) { cb->opFloatDouble(d1, f1, d2); },
                              makeExceptionClosure(cb));
#else
...

    {
        CallbackPtr cb = ICE_MAKE_SHARED(Callback);
#ifdef ICE_CPP11_MAPPING
        p->opStringAsync("hello", "world", [&](string s1, string s2) { cb->opString(move(s1), move(s2)); },
                         makeExceptionClosure(cb));
#else
        Test::Callback_MyClass_opStringPtr callback =
            Test::newCallback_MyClass_opString(cb, &Callback::opString, &Callback::exCB);
...
#else
        Test::Callback_MyClass_opMyEnumPtr callback =
            Test::newCallback_MyClass_opMyEnum(cb, &Callback::opMyEnum, &Callback::exCB);
...

    {
        ...
        p->opMyClassAsync(p,
                          ...
                          makeExceptionClosure(cb));
#else
        Test::Callback_MyClass_opMyClassPtr callback =
            Test::newCallback_MyClass_opMyClass(cb, &Callback::opMyClass, &Callback::exCB);
...

    {
        ...
        p->opStructAsync(si1, si2,
                         [&](Test::Structure si3, Test::Structure si4) { cb->opStruct(move(si3), move(si4)); },
                         makeExceptionClosure(cb));
#else
        Test::Callback_MyClass_opStructPtr callback =
            Test::newCallback_MyClass_opStruct(cb, &Callback::opStruct, &Callback::exCB);
...

    {
        ...
        CallbackPtr cb = ICE_MAKE_SHARED(Callback);
#ifdef ICE_CPP11_MAPPING
        p->opByteSAsync(bsi1, bsi2, [&](Test::ByteS bsi3, Test::ByteS bsi4) { cb->opByteS(move(bsi3), move(bsi4)); },
                        makeExceptionClosure(cb));
#else
        Test::Callback_MyClass_opByteSPtr callback =
            Test::newCallback_MyClass_opByteS(cb, &Callback::opByteS, &Callback::exCB);
...

    {
        ...
        CallbackPtr cb = ICE_MAKE_SHARED(Callback);
#ifdef ICE_CPP11_MAPPING
        p->opBoolSAsync(bsi1, bsi2, [&](Test::BoolS bsi3, Test::BoolS bsi4) { cb->opBoolS(move(bsi3), move(bsi4)); },
                        makeExceptionClosure(cb));
#else
        Test::Callback_MyClass_opBoolSPtr callback =
            Test::newCallback_MyClass_opBoolS(cb, &Callback::opBoolS, &Callback::exCB);
...

    {
        ...
        p->opStringSAsync(ssi1, ssi2,
                          [&](Test::StringS ssi3, Test::StringS ssi4) { cb->opStringS(move(ssi3), move(ssi4)); },
                          makeExceptionClosure(cb));
#else
        Test::Callback_MyClass_opStringSPtr callback =
            Test::newCallback_MyClass_opStringS(cb, &Callback::opStringS, &Callback::exCB);
...

    {
        ...
        p->opByteSSAsync(bsi1, bsi2,
                         [&](Test::ByteSS bsi3, Test::ByteSS bsi4) { cb->opByteSS(move(bsi3), move(bsi4)); },
                         makeExceptionClosure(cb));
#else
        Test::Callback_MyClass_opByteSSPtr callback =
            Test::newCallback_MyClass_opByteSS(cb, &Callback::opByteSS, &Callback::exCB);
...

    {
        ...
        p->opBoolSSAsync(bsi1, bsi2,
                         [&](Test::BoolSS bsi3, Test::BoolSS bsi4) { cb->opBoolSS(move(bsi3), move(bsi4)); },
                         makeExceptionClosure(cb));
#else
        Test::Callback_MyClass_opBoolSSPtr callback =
            Test::newCallback_MyClass_opBoolSS(cb, &Callback::opBoolSS, &Callback::exCB);
...

    {
        ...
        p->opShortIntLongSSAsync(ssi, isi, lsi,
                                 ...
                                 makeExceptionClosure(cb));
#else
        Test::Callback_MyClass_opShortIntLongSSPtr callback =
            Test::newCallback_MyClass_opShortIntLongSS(cb, &Callback::opShortIntLongSS, &Callback::exCB);
...

    {
        ...
        p->opStringSSAsync(ssi1, ssi2,
                           [&](Test::StringSS ssi3, Test::StringSS ssi4) { cb->opStringSS(move(ssi3), move(ssi4)); },
                           makeExceptionClosure(cb));
#else
...

    {
        ...
        p->opByteBoolDAsync(di1, di2,
                            [&](Test::ByteBoolD di3, Test::ByteBoolD di4) { cb->opByteBoolD(move(di3), move(di4)); },
                            makeExceptionClosure(cb));
#else
...

    {
        ...
        p->opShortIntDAsync(di1, di2,
                            [&](Test::ShortIntD di3, Test::ShortIntD di4) { cb->opShortIntD(move(di3), move(di4)); },
                            makeExceptionClosure(cb));
#else
...
#ifdef ICE_CPP11_MAPPING
        p->opLongFloatDAsync(
            di1, di2, [&](Test::LongFloatD di3, Test::LongFloatD di4) { cb->opLongFloatD(move(di3), move(di4)); },
            makeExceptionClosure(cb));
#else
...

    {
        ...
        p->opStringStringDAsync(
            di1, di2,
            [&](Test::StringStringD di3, Test::StringStringD di4) { cb->opStringStringD(move(di3), move(di4)); },
            makeExceptionClosure(cb));
#else
...

    {
        ...
        p->opStringMyEnumDAsync(
            di1, di2,
            [&](Test::StringMyEnumD di3, Test::StringMyEnumD di4) { cb->opStringMyEnumD(move(di3), move(di4)); },
            makeExceptionClosure(cb));
#else
...

    {
        ...
        p->opMyStructMyEnumDAsync(
            di1, di2,
            [&](Test::MyStructMyEnumD di3, Test::MyStructMyEnumD di4) { cb->opMyStructMyEnumD(move(di3), move(di4)); },
            makeExceptionClosure(cb));
#else
...
#ifdef ICE_CPP11_MAPPING
        p->opByteBoolDSAsync(
            dsi1, dsi2, [&](Test::ByteBoolDS dsi3, Test::ByteBoolDS dsi4) { cb->opByteBoolDS(move(dsi3), move(dsi4)); },
            makeExceptionClosure(cb));
#else
...
#ifdef ICE_CPP11_MAPPING
        p->opShortIntDSAsync(
            dsi1, dsi2, [&](Test::ShortIntDS dsi3, Test::ShortIntDS dsi4) { cb->opShortIntDS(move(dsi3), move(dsi4)); },
            makeExceptionClosure(cb));
#else
...

    {
        ...
        p->opLongFloatDSAsync(
            dsi1, dsi2,
            [&](Test::LongFloatDS dsi3, Test::LongFloatDS dsi4) { cb->opLongFloatDS(move(dsi3), move(dsi4)); },
            makeExceptionClosure(cb));
#else
...

    {
        ...
        p->opStringStringDSAsync(
            dsi1, dsi2,
            [&](Test::StringStringDS dsi3, Test::StringStringDS dsi4) { cb->opStringStringDS(move(dsi3), move(dsi4)); },
            makeExceptionClosure(cb));
...

    {
        ...
        p->opStringMyEnumDSAsync(
            dsi1, dsi2,
            [&](Test::StringMyEnumDS dsi3, Test::StringMyEnumDS dsi4) { cb->opStringMyEnumDS(move(dsi3), move(dsi4)); },
            makeExceptionClosure(cb));
#else
...

    {
        ...
        p->opMyEnumStringDSAsync(
            dsi1, dsi2,
            [&](Test::MyEnumStringDS dsi3, Test::MyEnumStringDS dsi4) { cb->opMyEnumStringDS(move(dsi3), move(dsi4)); },
            makeExceptionClosure(cb));
#else
...

    {
        ...
        p->opMyStructMyEnumDSAsync(
            dsi1, dsi2,
            [&](Test::MyStructMyEnumDS dsi3, MyStructMyEnumDS dsi4) { cb->opMyStructMyEnumDS(move(dsi3), move(dsi4)); },
            makeExceptionClosure(cb));
#else
...
#ifdef ICE_CPP11_MAPPING
        p->opByteByteSDAsync(
            sdi1, sdi2, [&](Test::ByteByteSD sdi3, Test::ByteByteSD sdi4) { cb->opByteByteSD(move(sdi3), move(sdi4)); },
            makeExceptionClosure(cb));
#else
...
#ifdef ICE_CPP11_MAPPING
        p->opBoolBoolSDAsync(
            sdi1, sdi2, [&](Test::BoolBoolSD sdi3, Test::BoolBoolSD sdi4) { cb->opBoolBoolSD(move(sdi3), move(sdi4)); },
            makeExceptionClosure(cb));
#else
...

    {
        ...
        p->opShortShortSDAsync(
            sdi1, sdi2,
            [&](Test::ShortShortSD sdi3, Test::ShortShortSD sdi4) { cb->opShortShortSD(move(sdi3), move(sdi4)); },
            makeExceptionClosure(cb));
#else
...

    {
        ...
        p->opIntIntSDAsync(sdi1, sdi2,
                           [&](Test::IntIntSD sdi3, Test::IntIntSD sdi4) { cb->opIntIntSD(move(sdi3), move(sdi4)); },
                           makeExceptionClosure(cb));
#else
...
#ifdef ICE_CPP11_MAPPING
        p->opLongLongSDAsync(
            sdi1, sdi2, [&](Test::LongLongSD sdi3, Test::LongLongSD sdi4) { cb->opLongLongSD(move(sdi3), move(sdi4)); },
            makeExceptionClosure(cb));
#else
...

    {
        ...
        p->opStringFloatSDAsync(
            sdi1, sdi2,
            [&](Test::StringFloatSD sdi3, Test::StringFloatSD sdi4) { cb->opStringFloatSD(move(sdi3), move(sdi4)); },
            makeExceptionClosure(cb));
#else
...

    {
        ...
        p->opStringDoubleSDAsync(
            sdi1, sdi2,
            [&](Test::StringDoubleSD sdi3, Test::StringDoubleSD sdi4) { cb->opStringDoubleSD(move(sdi3), move(sdi4)); },
            makeExceptionClosure(cb));
#else
...

    {
        ...
        p->opStringStringSDAsync(
            sdi1, sdi2,
            [&](Test::StringStringSD sdi3, Test::StringStringSD sdi4) { cb->opStringStringSD(move(sdi3), move(sdi4)); },
            makeExceptionClosure(cb));
#else
...

    {
        ...
        p->opMyEnumMyEnumSDAsync(
            sdi1, sdi2,
            [&](Test::MyEnumMyEnumSD sdi3, Test::MyEnumMyEnumSD sdi4) { cb->opMyEnumMyEnumSD(move(sdi3), move(sdi4)); },
            makeExceptionClosure(cb));
#else
...

    {
        ...
        for(unsigned int l = 0; l != sizeof(lengths) / sizeof(*lengths); ++l)
        {
            ...
            CallbackPtr cb = ICE_MAKE_SHARED(Callback);
#ifdef ICE_CPP11_MAPPING
            p->opIntSAsync(s, [&](Test::IntS s1) { cb->opIntS(s1); }, makeExceptionClosure(cb));
#else
