...
size_t MyByteSeq::size() const
{
    return _size;
}

void MyByteSeq::swap(MyByteSeq& seq)
{
...
MyByteSeq::const_iterator MyByteSeq::begin() const
{
    return _data;
}

MyByteSeq::const_iterator MyByteSeq::end() const
{
    return _data + _size;
}

void MyByteSeq::operator=(const MyByteSeq& rhs)
{
    delete[] _data;
    _data = 0;
...
bool MyByteSeq::operator==(const MyByteSeq& rhs) const
{
    if(_size != rhs._size)
    {
