...
namespace Test
{
    ...
    public:
        ...
        virtual void fromUTF8(const Ice::Byte* sourceStart, const Ice::Byte* sourceEnd, std::string& target) const;
    };
    ...
    public:
        ...
        virtual void fromUTF8(const Ice::Byte* sourceStart, const Ice::Byte* sourceEnd, std::wstring& target) const;
    };
