...
namespace Slice
{
    void generate(const UnitPtr&, const ::std::string&, const ::std::string&, const ::std::string&, const std::string&,
                  const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, unsigned,
                  unsigned, const ::std::vector<std::string>& = ::std::vector<std::string>());
    ...
    protected:
        ...
        ::std::string toString(const SyntaxTreeBasePtr&, const ContainerPtr&, bool = true, bool = false, size_t* = 0,
                               bool = false);
