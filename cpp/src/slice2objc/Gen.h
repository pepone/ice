...
namespace Slice
{
    ...
    {
    public:
        Gen(const std::string&, const std::string&, const std::string&, const std::vector<std::string>&,
    ...
    private:
        ...
        private:
            ...
            void writeInit(const ContainedPtr&, const DataMemberList&, const DataMemberList&, const DataMemberList&,
                           bool, int, ContainerType) const;
