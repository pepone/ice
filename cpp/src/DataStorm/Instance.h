...
namespace DataStormI
{
    ...
    public:
        ...
        // Helper methods to schedule and cancel timer tasks using the instance's timer.
        // Any attempts to schedule or cancel tasks after the instance is destroyed are ignored.
