...
namespace IceInternal
{
    ...
    private:
        ...
        using RouterInfoTable = std::map<std::shared_ptr<Ice::RouterPrx>, RouterInfoPtr,
    ...
    public:
        ...
        {
        public:
            AddProxyCookie(const AddProxyCallbackPtr cb, const Ice::ObjectPrxPtr& proxy) : _cb(cb), _proxy(proxy)
            {
            }
