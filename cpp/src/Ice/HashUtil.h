...
{
    inline void hashAdd(Ice::Int& hashCode, Ice::Int value)
    {
        hashCode = ((hashCode << 5) + hashCode) ^ (2654435761u * value);
    }

    inline void hashAdd(Ice::Int& hashCode, bool value)
    {
        hashCode = ((hashCode << 5) + hashCode) ^ (value ? 1 : 0);
    }

    inline void hashAdd(Ice::Int& hashCode, const std::string& value)
    {
    ...
    template<typename T> void hashAdd(Ice::Int& hashCode, const std::vector<T>& seq)
    {
    ...
    template<typename K, typename V> void hashAdd(Ice::Int& hashCode, const std::map<K, V>& map)
    {
