...
namespace IceInternal
{
    ...
    public:
        ...
        const Ice::ProtocolVersion& getProtocol() const
        {
            return _protocol;
        }
        ...
        const Ice::Identity& getIdentity() const
        {
            return _identity;
        }
        ...
        const SharedContextPtr& getContext() const
        {
            return _context;
        }
        int getInvocationTimeout() const
        {
    ...
    public:
        FixedReference(const InstancePtr&, const Ice::CommunicatorPtr&, const Ice::Identity&, const std::string&, Mode,
                       bool, const Ice::ProtocolVersion&, const Ice::EncodingVersion&, const Ice::ConnectionIPtr&, int,
                       const Ice::Context&, const IceUtil::Optional<bool>&);
    ...
    {
    public:
        RoutableReference(const InstancePtr&, const Ice::CommunicatorPtr&, const Ice::Identity&, const std::string&,
                          Mode, bool, const Ice::ProtocolVersion&, const Ice::EncodingVersion&,
                          const std::vector<EndpointIPtr>&, const std::string&, const LocatorInfoPtr&,
                          const RouterInfoPtr&, bool, bool, bool, Ice::EndpointSelectionType, int, int,
                          const Ice::Context&);
