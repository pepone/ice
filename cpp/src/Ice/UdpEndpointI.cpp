...
IceUtil::Shared* IceInternal::upCast(UdpEndpointI* p)
{
    return p;
}
#endif
...
extern "C"
{
    Plugin* createIceUDP(const CommunicatorPtr& c, const string&, const StringSeq&)
    {
        return new EndpointFactoryPlugin(
            c, new UdpEndpointFactory(new ProtocolInstance(c, UDPEndpointType, "udp", false)));
    }
}
...
//
extern "C" ICE_API void ICEregisterIceUDP(bool loadOnInitialize)
{
...
void IceInternal::UdpEndpointI::streamWriteImpl(OutputStream* s) const
{
...
EndpointInfoPtr IceInternal::UdpEndpointI::getInfo() const ICE_NOEXCEPT
{
    Ice::UDPEndpointInfoPtr info = ICE_MAKE_SHARED(
        InfoI<Ice::UDPEndpointInfo>, ICE_DYNAMIC_CAST(UdpEndpointI, ICE_SHARED_FROM_CONST_THIS(UdpEndpointI)));
    fillEndpointInfo(info.get());
    return info;
}

Int IceInternal::UdpEndpointI::timeout() const
{
    return -1;
}

EndpointIPtr IceInternal::UdpEndpointI::timeout(Int) const
{
    return ICE_SHARED_FROM_CONST_THIS(UdpEndpointI);
}

bool IceInternal::UdpEndpointI::compress() const
{
    return _compress;
}

EndpointIPtr IceInternal::UdpEndpointI::compress(bool compress) const
{
    ...
    {
        return ICE_MAKE_SHARED(UdpEndpointI, _instance, _host, _port, _sourceAddr, _mcastInterface, _mcastTtl, _connect,
                               _connectionId, compress);
    }
}

bool IceInternal::UdpEndpointI::datagram() const
{
    return true;
}

TransceiverPtr IceInternal::UdpEndpointI::transceiver() const
{
...
AcceptorPtr IceInternal::UdpEndpointI::acceptor(const string&) const
{
    return 0;
}

UdpEndpointIPtr IceInternal::UdpEndpointI::endpoint(const UdpTransceiverPtr& transceiver) const
{
...
void IceInternal::UdpEndpointI::initWithOptions(vector<string>& args, bool oaEndpoint)
{
...
string IceInternal::UdpEndpointI::options() const
{
    //
...
void IceInternal::UdpEndpointI::hashInit(Ice::Int& h) const
{
...
void IceInternal::UdpEndpointI::fillEndpointInfo(IPEndpointInfo* info) const
{
...
bool IceInternal::UdpEndpointI::checkOption(const string& option, const string& argument, const string& endpoint)
{
    ...
    if(option == "-c")
    {
        if(!argument.empty())
        {
            throw EndpointParseException(
                __FILE__, __LINE__, "unexpected argument `" + argument + "' provided for -c option in " + endpoint);
        }
...
ConnectorPtr IceInternal::UdpEndpointI::createConnector(const Address& address, const NetworkProxyPtr&) const
{
    return new UdpConnector(_instance, address, _sourceAddr, _mcastInterface, _mcastTtl, _connectionId);
}

IPEndpointIPtr IceInternal::UdpEndpointI::createEndpoint(const string& host, int port, const string& connectionId) const
{
...
Short IceInternal::UdpEndpointFactory::type() const
{
    return _instance->type();
}

string IceInternal::UdpEndpointFactory::protocol() const
{
    return _instance->protocol();
}

EndpointIPtr IceInternal::UdpEndpointFactory::create(vector<string>& args, bool oaEndpoint) const
{
...
EndpointIPtr IceInternal::UdpEndpointFactory::read(InputStream* s) const
{
    return ICE_MAKE_SHARED(UdpEndpointI, _instance, s);
}

void IceInternal::UdpEndpointFactory::destroy()
{
    _instance = 0;
}

EndpointFactoryPtr IceInternal::UdpEndpointFactory::clone(const ProtocolInstancePtr& instance) const
{
