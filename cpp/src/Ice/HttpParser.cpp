...
const Ice::Byte* IceInternal::HttpParser::isCompleteMessage(const Ice::Byte* begin, const Ice::Byte* end) const
{
...
bool IceInternal::HttpParser::parse(const Ice::Byte* begin, const Ice::Byte* end)
{
    const Ice::Byte* p = begin;
...
HttpParser::Type IceInternal::HttpParser::type() const
{
    return _type;
}

string IceInternal::HttpParser::method() const
{
    assert(_type == TypeRequest);
    return _method;
}

string IceInternal::HttpParser::uri() const
{
    assert(_type == TypeRequest);
    return _uri;
}

int IceInternal::HttpParser::versionMajor() const
{
    return _versionMajor;
}

int IceInternal::HttpParser::versionMinor() const
{
    return _versionMinor;
}

int IceInternal::HttpParser::status() const
{
    return _status;
}

string IceInternal::HttpParser::reason() const
{
    return _reason;
}

bool IceInternal::HttpParser::getHeader(const string& name, string& value, bool toLower) const
{
...
map<string, string> IceInternal::HttpParser::getHeaders() const
{
