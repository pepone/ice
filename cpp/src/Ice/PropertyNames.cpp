...
//
// **********************************************************************
// Generated by makeprops.py from file .\config\PropertyNames.xml, Fri Jan  4 18:17:00 2019
...
const IceInternal::Property IcePropsData[] =
{
    ...
    IceInternal::Property("Ice.PreloadAssemblies", false, 0),
...
const IceInternal::Property IceGridAdminPropsData[] =
{
    ...
    IceInternal::Property("IceGridAdmin.Server.ACM.Timeout", false, 0),
    IceInternal::Property("IceGridAdmin.Server.ACM.Heartbeat", false, 0),
    IceInternal::Property("IceGridAdmin.Server.ACM.Close", false, 0),
    IceInternal::Property("IceGridAdmin.Server.ACM", false, 0),
    IceInternal::Property("IceGridAdmin.Server.AdapterId", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Endpoints", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Locator.EndpointSelection", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Locator.ConnectionCached", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Locator.PreferSecure", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Locator.LocatorCacheTimeout", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Locator.InvocationTimeout", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Locator.Locator", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Locator.Router", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Locator.CollocationOptimized", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Locator.Context.*", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Locator", false, 0),
    IceInternal::Property("IceGridAdmin.Server.PublishedEndpoints", false, 0),
    IceInternal::Property("IceGridAdmin.Server.ReplicaGroupId", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Router.EndpointSelection", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Router.ConnectionCached", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Router.PreferSecure", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Router.LocatorCacheTimeout", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Router.InvocationTimeout", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Router.Locator", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Router.Router", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Router.CollocationOptimized", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Router.Context.*", false, 0),
    IceInternal::Property("IceGridAdmin.Server.Router", false, 0),
    IceInternal::Property("IceGridAdmin.Server.ProxyOptions", false, 0),
    IceInternal::Property("IceGridAdmin.Server.ThreadPool.Size", false, 0),
    IceInternal::Property("IceGridAdmin.Server.ThreadPool.SizeMax", false, 0),
    IceInternal::Property("IceGridAdmin.Server.ThreadPool.SizeWarn", false, 0),
    IceInternal::Property("IceGridAdmin.Server.ThreadPool.StackSize", false, 0),
    IceInternal::Property("IceGridAdmin.Server.ThreadPool.Serialize", false, 0),
    IceInternal::Property("IceGridAdmin.Server.ThreadPool.ThreadIdleTime", false, 0),
    IceInternal::Property("IceGridAdmin.Server.ThreadPool.ThreadPriority", false, 0),
    IceInternal::Property("IceGridAdmin.Server.MessageSizeMax", false, 0),
