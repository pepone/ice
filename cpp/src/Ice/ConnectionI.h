...
namespace Ice
{
    ...
    public:
        ...
        virtual AsyncResultPtr begin_flushBatchRequests(CompressBatch, const Callback_Connection_flushBatchRequestsPtr&,
        ...
        virtual void setACM(const IceUtil::Optional<int>&, const IceUtil::Optional<ACMClose>&,
        ...
        void dispatch(const StartCallbackPtr&, const std::vector<OutgoingMessage>&, Byte, Int, Int,
                      ...
                      const IceInternal::OutgoingAsyncBasePtr&, const ICE_DELEGATE(HeartbeatCallback) &,
                      Ice::InputStream&);
        void finish(bool);
    ...
    private:
        ...
        static ConnectionIPtr create(const Ice::CommunicatorPtr&, const IceInternal::InstancePtr&,
                                     const IceInternal::ACMMonitorPtr&, const IceInternal::TransceiverPtr&,
                                     const IceInternal::ConnectorPtr&, const IceInternal::EndpointIPtr&,
        ...
        IceInternal::SocketOperation parseMessage(Ice::InputStream&, Int&, Int&, Byte&, IceInternal::ServantManagerPtr&,
                                                  ObjectAdapterPtr&, IceInternal::OutgoingAsyncBasePtr&,
                                                  ICE_DELEGATE(HeartbeatCallback) &, int&);

        void invokeAll(Ice::InputStream&, Int, Int, Byte, const IceInternal::ServantManagerPtr&,
        ...
        AsyncResultPtr _iceI_begin_flushBatchRequests(CompressBatch, const IceInternal::CallbackBasePtr&,
