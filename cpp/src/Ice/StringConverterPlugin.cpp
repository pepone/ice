...
extern "C"
{
    ICE_API Plugin* createStringConverter(const CommunicatorPtr& communicator, const string& name,
...
//
extern "C" ICE_API void ICEregisterIceStringConverter(bool loadOnInitialize)
{
