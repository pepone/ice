...
IceUtil::Shared* Ice::upCast(SliceInfo* p)
{
    return p;
}
IceUtil::Shared* Ice::upCast(SlicedData* p)
{
    return p;
}
IceUtil::Shared* Ice::upCast(UnknownSlicedValue* p)
{
    return p;
}
...
#ifndef ICE_CPP11_MAPPING
void Ice::SlicedData::_iceGcVisitMembers(IceInternal::GCVisitor& visitor)
{
    //
...
SlicedDataPtr Ice::UnknownSlicedValue::ice_getSlicedData() const
{
    return _slicedData;
}
...
string Ice::UnknownSlicedValue::ice_id() const
{
    return _unknownTypeId;
}

shared_ptr<Ice::UnknownSlicedValue> Ice::UnknownSlicedValue::ice_clone() const
{
    return static_pointer_cast<UnknownSlicedValue>(_iceCloneImpl());
}

shared_ptr<Ice::Value> Ice::UnknownSlicedValue::_iceCloneImpl() const
{
...
const string& Ice::UnknownSlicedValue::ice_id(const Current&) const
{
    return _unknownTypeId;
}

void Ice::UnknownSlicedValue::_iceGcVisitMembers(IceInternal::GCVisitor& _v)
{
    if(_slicedData)
    {
...
void Ice::UnknownSlicedValue::_iceWrite(Ice::OutputStream* ostr) const
{
    ostr->startValue(_slicedData);
    ostr->endValue();
}

void Ice::UnknownSlicedValue::_iceRead(Ice::InputStream* istr)
{
    istr->startValue();
