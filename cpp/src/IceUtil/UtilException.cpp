...
namespace
{
    ...
    int ignoreFrame(void*, uintptr_t pc, const char*, int, const char*)
    {
        assert(pc == 0);
        return 0;
    }
...
void IceUtil::Exception::ice_print(ostream& out) const
{
    if(_file && _line > 0)
    {
        out << _file << ':' << _line << ": ";
...
const char* IceUtil::Exception::what() const ICE_NOEXCEPT
{
    try
    {
        IceUtilInternal::MutexPtrLock<IceUtil::Mutex> lock(globalMutex);
...
string IceUtil::Exception::ice_name() const
{
...
string IceUtil::Exception::ice_stackTrace() const
{
    return getStackTrace(_stackFrames);
}

#ifdef ICE_CPP11_MAPPING
unique_ptr<IceUtil::Exception> IceUtil::Exception::ice_clone() const
{
    return unique_ptr<Exception>(ice_cloneImpl());
}
#endif

ostream& IceUtil::operator<<(ostream& out, const IceUtil::Exception& ex)
{
    ex.ice_print(out);
    return out;
}
...
string IceUtil::NullHandleException::ice_id() const
{
    return "::IceUtil::NullHandleException";
}

#ifndef ICE_CPP11_MAPPING
IceUtil::NullHandleException* IceUtil::NullHandleException::ice_clone() const
{
...
void IceUtil::IllegalArgumentException::ice_print(ostream& out) const
{
    Exception::ice_print(out);
    out << ": " << _reason;
}

string IceUtil::IllegalArgumentException::ice_id() const
{
    return "::IceUtil::IllegalArgumentException";
}

#ifndef ICE_CPP11_MAPPING
IceUtil::IllegalArgumentException* IceUtil::IllegalArgumentException::ice_clone() const
{
    return new IllegalArgumentException(*this);
}
#endif

string IceUtil::IllegalArgumentException::reason() const
{
    return _reason;
}
...
void IceUtil::IllegalConversionException::ice_print(ostream& out) const
{
    Exception::ice_print(out);
    out << ": " << _reason;
}

string IceUtil::IllegalConversionException::ice_id() const
{
    return "::IceUtil::IllegalConversionException";
}

#ifndef ICE_CPP11_MAPPING
IceUtil::IllegalConversionException* IceUtil::IllegalConversionException::ice_clone() const
{
    return new IllegalConversionException(*this);
}
#endif

string IceUtil::IllegalConversionException::reason() const
{
    return _reason;
}
...
void IceUtil::SyscallException::ice_print(ostream& os) const
{
...
string IceUtil::SyscallException::ice_id() const
{
    return "::IceUtil::SyscallException";
}

#ifndef ICE_CPP11_MAPPING
IceUtil::SyscallException* IceUtil::SyscallException::ice_clone() const
{
...
void IceUtil::FileLockException::ice_print(ostream& os) const
{
    Exception::ice_print(os);
...
string IceUtil::FileLockException::ice_id() const
{
    return "::IceUtil::FileLockException";
}

#ifndef ICE_CPP11_MAPPING
IceUtil::FileLockException* IceUtil::FileLockException::ice_clone() const
{
...
string IceUtil::OptionalNotSetException::ice_id() const
{
    return "::IceUtil::OptionalNotSetException";
}

#ifndef ICE_CPP11_MAPPING
IceUtil::OptionalNotSetException* IceUtil::OptionalNotSetException::ice_clone() const
{
