...
void IceUtil::setProcessStringConverter(const StringConverterPtr& converter)
{
    IceUtilInternal::MutexPtrLock<IceUtil::Mutex> lock(processStringConverterMutex);
...
void IceUtil::setProcessWstringConverter(const WstringConverterPtr& converter)
{
    IceUtilInternal::MutexPtrLock<IceUtil::Mutex> lock(processStringConverterMutex);
    processWstringConverter = converter;
}

string IceUtil::wstringToString(const wstring& v, const StringConverterPtr& converter,
...
wstring IceUtil::stringToWstring(const string& v, const StringConverterPtr& converter,
                                 const WstringConverterPtr& wConverter)
{
    wstring target;
    if(!v.empty())
...
string IceUtil::nativeToUTF8(const string& str, const IceUtil::StringConverterPtr& converter)
{
...
string IceUtil::UTF8ToNative(const string& str, const IceUtil::StringConverterPtr& converter)
{
    if(!converter || str.empty())
    {
        return str;
...
vector<unsigned short> IceUtilInternal::toUTF16(const vector<Byte>& source)
{
...
vector<unsigned int> IceUtilInternal::toUTF32(const vector<Byte>& source)
{
...
vector<Byte> IceUtilInternal::fromUTF32(const vector<unsigned int>& source)
{
    vector<Byte> result;
    if(!source.empty())
    {
...
StringConverterPtr IceUtil::createWindowsStringConverter(unsigned int cp)
{
