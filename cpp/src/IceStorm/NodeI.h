...
namespace IceStormElection
{
    ...
    {
    public:
        NodeI(const IceStorm::InstancePtr&, const ReplicaPtr&, const Ice::ObjectPrx&, int,
    ...
    {
    public:
        FinishUpdateHelper(const NodeIPtr& node) : _node(node)
        {
        }
    ...
    {
    public:
        CachedReadHelper(const NodeIPtr& node, const char* file, int line) : _node(node)
        {
            if(_node)
            {
    ...
    {
    public:
        ObserverUpdateHelper(const NodeIPtr& node, Ice::Long generation, const char* file, int line) : _node(node)
        {
            if(_node)
            {
