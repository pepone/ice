...
namespace IceGrid
{
    ...
    public:
        ...
        Database(const Ice::ObjectAdapterPtr&, const IceStorm::TopicManagerPrx&, const std::string&,
                 const TraceLevelsPtr&, const RegistryInfo&, bool);
        ...
        const Ice::ObjectAdapterPtr& getInternalAdapter()
        {
            return _internalAdapter;
        }
        ...
        Ice::ObjectPrx getObjectByType(const std::string&, const Ice::ConnectionPtr& = Ice::ConnectionPtr(),
        ...
        Ice::ObjectPrx getObjectByTypeOnLeastLoadedNode(const std::string&, LoadSample,
                                                        ...
                                                        const Ice::Context& = Ice::Context());
        Ice::ObjectProxySeq getObjectsByType(const std::string&, const Ice::ConnectionPtr& = Ice::ConnectionPtr(),
                                             const Ice::Context& = Ice::Context());
