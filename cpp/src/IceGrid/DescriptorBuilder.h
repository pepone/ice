...
namespace IceGrid
{
    ...
    public:
        ...
        ApplicationDescriptorBuilder(const Ice::CommunicatorPtr&, const ApplicationDescriptor&,
    ...
    public:
        ...
        const ServerInstanceDescriptor& getDescriptor() const
        {
            return _descriptor;
        }
    ...
    public:
        ...
        const TemplateDescriptor& getDescriptor() const
        {
            return _descriptor;
        }
    ...
    public:
        ...
        const ServiceInstanceDescriptor& getDescriptor() const
        {
            return _descriptor;
        }
