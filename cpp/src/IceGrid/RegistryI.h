...
namespace IceGrid
{
    ...
    public:
        ...
        std::string getNodeAdminCategory() const
        {
            return _instanceName + "-RegistryNodeAdminRouter";
        }
        std::string getReplicaAdminCategory() const
        {
        ...
        const Ice::ObjectAdapterPtr& getRegistryAdapter()
        {
