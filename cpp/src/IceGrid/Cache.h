...
namespace IceGrid
{
    ...
    template<typename Key, typename Value> class Cache : public IceUtil::Monitor<IceUtil::Mutex>
    {
    ...
    public:
        ...
        void setTraceLevels(const TraceLevelsPtr& traceLevels)
        {
    ...
    protected:
        virtual ValuePtr getImpl(const Key& key) const
        {
        ...
        virtual ValuePtr addImpl(const Key& key, const ValuePtr& entry)
        {
        ...
        virtual void removeImpl(const Key& key)
        {
    ...
    public:
        virtual std::vector<std::string> getAll(const std::string& expr)
        {
