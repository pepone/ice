...
namespace IceGrid
{
    ...
    public:
        ...
        virtual void loadServer_async(const AMD_Node_loadServerPtr&, const InternalServerDescriptorPtr&,
        ...
        virtual void destroyServer_async(const AMD_Node_destroyServerPtr&, const std::string&, const std::string&, int,
                                         const std::string&, const Ice::Current&);
        ...
        virtual void patch_async(const AMD_Node_patchPtr&, const PatcherFeedbackPrx&, const std::string&,
                                 const std::string&, const InternalDistributionDescriptorPtr&, bool,
                                 const Ice::Current&);
