...
namespace Glacier2
{
    template<typename T, class P> class FilterT : public P, public IceUtil::Monitor<IceUtil::Mutex>
    {
    public:
        //
    ...
    template<class T, class P> void FilterT<T, P>::add(const std::vector<T>& additions, const Ice::Current&)
    {
        //
    ...
    template<class T, class P> void FilterT<T, P>::remove(const std::vector<T>& deletions, const Ice::Current&)
    {
        //
