...
namespace Glacier2
{
    ...
    public:
        ...
        bool match(const string&, string::size_type&)
        {
            return true;
        }
    ...
    public:
        ...
        bool match(const string& space, string::size_type& pos)
        {
            assert(pos == 0);
    ...
    {
    public:
        AddressMatcher* create(const string& criteria)
        {
            return new StartsWithString(criteria);
        }

        AddressMatcher* create(const vector<int>& ports, const vector<Range>& ranges)
        {
    ...
    public:
        ...
        virtual bool check(const ObjectPrx& prx) const
        {
    ...
    static void parseProperty(const Ice::CommunicatorPtr& communicator, const string& property,
                              vector<ProxyRule*>& rules, const int traceLevel)
    {
    ...
    public:
        ...
        bool check(const ObjectPrx& p) const
        {
...
bool Glacier2::ProxyVerifier::verify(const ObjectPrx& proxy)
{
    //
