...
namespace
{
    ...
    void PackageVisitor::createModules(const UnitPtr& unit, const string& module, const string& dir)
    {
        StringList modules;
    ...
    void PackageVisitor::writeInit(const string& dir, const string& name, const StringList& modules,
...
int Slice::Python::compile(const vector<string>& argv)
{
