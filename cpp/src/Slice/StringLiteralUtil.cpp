...
namespace
{
    ...
    StringLiteralGenerator::StringLiteralGenerator(const string& nonPrintableEscaped, const string& printableEscaped,
                                                   EscapeMode escapeMode, unsigned char cutOff) :
    ...
    string StringLiteralGenerator::escapeCodePoint(unsigned int codePoint)
    {
        if(codePoint < 128)
        {
    ...
    string StringLiteralGenerator::flushU8Buffer(vector<unsigned char>& u8buffer)
    {
        if(u8buffer.empty())
        {
            return "";
    ...
    void StringLiteralGenerator::format(Format f)
    {
        _format = f;
    }
...
string Slice::toStringLiteral(const string& value, const string& nonPrintableEscaped, const string& printableEscaped,
                              EscapeMode escapeMode, unsigned char cutOff)
{
