...
namespace Slice
{
    ...
    protected:
        ...
        //
        std::string convertScopedName(const std::string&, const std::string& = std::string(),
        ...
        //
        std::string getAbsolute(const ContainedPtr&, const std::string& = std::string(),
                                const std::string& = std::string(), const std::string& = std::string()) const;
        ...
        void writeDictionaryMarshalUnmarshalCode(::IceUtilInternal::Output&, const std::string&, const DictionaryPtr&,
                                                 const std::string&, bool, int&, bool, const std::string& = "",
        ...
        //
        bool getDictionaryTypes(const DictionaryPtr&, const std::string&, const StringList&, std::string&,
                                std::string&) const;
        bool getSequenceTypes(const SequencePtr&, const std::string&, const StringList&, std::string&,
                              std::string&) const;
