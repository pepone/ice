...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    ICE_CONST = 280,               /* ICE_CONST  */
    ICE_FALSE = 281,               /* ICE_FALSE  */
    ICE_TRUE = 282,                /* ICE_TRUE  */
    ICE_IDEMPOTENT = 283,          /* ICE_IDEMPOTENT  */
    ICE_TAG = 284,                 /* ICE_TAG  */
    ICE_OPTIONAL = 285,            /* ICE_OPTIONAL  */
    ICE_VALUE = 286,               /* ICE_VALUE  */
    ICE_STRING_LITERAL = 287,      /* ICE_STRING_LITERAL  */
    ICE_INTEGER_LITERAL = 288,     /* ICE_INTEGER_LITERAL  */
    ICE_FLOATING_POINT_LITERAL = 289, /* ICE_FLOATING_POINT_LITERAL  */
    ICE_IDENTIFIER = 290,          /* ICE_IDENTIFIER  */
    ICE_SCOPED_IDENTIFIER = 291,   /* ICE_SCOPED_IDENTIFIER  */
    ICE_METADATA_OPEN = 292,       /* ICE_METADATA_OPEN  */
    ICE_METADATA_CLOSE = 293,      /* ICE_METADATA_CLOSE  */
    ICE_GLOBAL_METADATA_OPEN = 294, /* ICE_GLOBAL_METADATA_OPEN  */
    ICE_GLOBAL_METADATA_IGNORE = 295, /* ICE_GLOBAL_METADATA_IGNORE  */
    ICE_GLOBAL_METADATA_CLOSE = 296, /* ICE_GLOBAL_METADATA_CLOSE  */
    ICE_IDENT_OPEN = 297,          /* ICE_IDENT_OPEN  */
    ICE_KEYWORD_OPEN = 298,        /* ICE_KEYWORD_OPEN  */
    ICE_TAG_OPEN = 299,            /* ICE_TAG_OPEN  */
    ICE_OPTIONAL_OPEN = 300,       /* ICE_OPTIONAL_OPEN  */
    BAD_CHAR = 301                 /* BAD_CHAR  */
  };
