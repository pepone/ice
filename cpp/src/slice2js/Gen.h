...
namespace Slice
{
    ...
    public:
        ...
        [[nodiscard]] const std::map<std::string, std::map<std::string, std::set<std::string>>>& moduleIncludes() const;
        [[nodiscard]] const std::map<std::string, std::map<std::string, std::set<std::string>>>&
        fileImportedTypes() const;
    ...
    private:
        ...
        // Map of Slice files to imported modules per direct include file.
        ...
        // - Value is a set of modules defined in the included file, either directly or transitively.
        std::map<std::string, std::map<std::string, std::set<std::string>>> _moduleIncludes;
        ...
        std::map<std::string, std::map<std::string, std::set<std::string>>> _fileImportedTypes;
    ...
    private:
        ...
        private:
            ...
            std::map<std::string, std::set<std::string>> _fileImportedTypes;
        };
