...
namespace Slice
{
    ...
    protected:
        ...
        std::string writeConstantValue(const std::string&, const TypePtr&, const SyntaxTreeBasePtr&,
                                       const std::string&);
    ...
    public:
        ...
        Gen(const std::string&, const std::vector<std::string>&, const std::string&, std::ostream&);
