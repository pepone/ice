...
namespace IceBT
{
    namespace DBus
    {
        ...
        template<typename E, Type::Kind K> class PrimitiveValue : public Value
        {
        public:
        ...
        public:
            ...
            VariantValue(const ValuePtr& val) : v(val), _type(new VariantType)
            {
            }
        ...
        public:
            ...
            static MessagePtr createCall(const string& dest, const string& path, const string& iface,
                                         const string& method);
