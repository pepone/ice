...
namespace
{
    ...
    private:
        ...
        {
        public:
            HelperThread(ConnectionI* con) : _con(con)
            {
            }
...
TypePtr IceBT::DBus::Type::getPrimitive(Kind k)
{
    switch(k)
    {
        case KindBoolean:
...
string IceBT::DBus::ArrayType::getSignature() const
{
...
string IceBT::DBus::VariantType::getSignature() const
{
    return DBUS_TYPE_VARIANT_AS_STRING;
}

string IceBT::DBus::StructType::getSignature() const
{
    string r = "(";
...
string IceBT::DBus::DictEntryType::getSignature() const
{
    string r = "{";
...
MessagePtr IceBT::DBus::Message::createCall(const string& dest, const string& path, const string& iface,
                                            const string& method)
{
...
MessagePtr IceBT::DBus::Message::createReturn(const MessagePtr& call)
{
...
ConnectionPtr IceBT::DBus::Connection::getSystemBus()
{
...
ConnectionPtr IceBT::DBus::Connection::getSessionBus()
{
    ConnectionI* conn = new ConnectionI;
    conn->connect(false);
    return conn;
