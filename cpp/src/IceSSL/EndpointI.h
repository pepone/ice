...
namespace IceSSL
{
    ...
    public:
        ...
        virtual IceInternal::EndpointFactoryPtr cloneWithUnderlying(const IceInternal::ProtocolInstancePtr&,
                                                                    Ice::Short) const;

    protected:
        virtual IceInternal::EndpointIPtr createWithUnderlying(const IceInternal::EndpointIPtr&,
                                                               std::vector<std::string>&, bool) const;
        virtual IceInternal::EndpointIPtr readWithUnderlying(const IceInternal::EndpointIPtr&, Ice::InputStream*) const;
