...
//
PluginI::PluginI(const Ice::CommunicatorPtr& com) : IceSSL::PluginI(com, new IceSSL::SChannel::SSLEngine(com))
{
}

IceSSL::CertificatePtr PluginI::create(CERT_SIGNED_CONTENT_INFO* cert) const
{
