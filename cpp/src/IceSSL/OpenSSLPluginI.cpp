...
//
PluginI::PluginI(const Ice::CommunicatorPtr& com) : IceSSL::PluginI(com, new IceSSL::OpenSSL::SSLEngine(com))
{
}

Ice::Long PluginI::getOpenSSLVersion() const
{
    return SSLeay();
}

IceSSL::CertificatePtr PluginI::create(x509_st* cert) const
{
...
void PluginI::setContext(SSL_CTX* context)
{
...
//
extern "C" ICESSL_OPENSSL_API Ice::Plugin* createIceSSLOpenSSL(const Ice::CommunicatorPtr& communicator,
                                                               const string& /*name*/, const Ice::StringSeq& /*args*/)
{
