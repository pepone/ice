...
//
PluginI::PluginI(const Ice::CommunicatorPtr& com) : IceSSL::PluginI(com, new IceSSL::UWP::SSLEngine(com))
{
}

IceSSL::CertificatePtr PluginI::create(Windows::Security::Cryptography::Certificates::Certificate ^ cert) const
{
...
string PluginI::getEngineName() const
{
    return "UWPEngine";
}

Ice::Long PluginI::getEngineVersion() const
{
    return 0;
}
