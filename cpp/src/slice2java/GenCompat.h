...
namespace Slice
{
    ...
    protected:
        ...
        std::vector<std::string> getParamsAsyncLambda(const OperationPtr&, const std::string&, bool context = false,
                                                      bool sentCB = false, bool optionalMapping = false,
                                                      bool inParams = true, bool internal = false);
        std::vector<std::string> getArgsAsyncLambda(const OperationPtr&, const std::string&, bool context = false,
                                                    bool sentCB = false);
        ...
        void writeMarshalUnmarshalParams(::IceUtilInternal::Output&, const std::string&, const ParamDeclList&,
                                         const OperationPtr&, int&, bool, bool, bool, const std::string& = "",
                                         bool = false);
        ...
        void writeMarshalDataMember(::IceUtilInternal::Output&, const std::string&, const DataMemberPtr&, int&,
                                    bool = false);
        void writeUnmarshalDataMember(::IceUtilInternal::Output&, const std::string&, const DataMemberPtr&, int&, bool,
                                      int&, bool = false);
        ...
        //
        void writeConstantValue(::IceUtilInternal::Output&, const TypePtr&, const SyntaxTreeBasePtr&,
        ...
        static void writeDocComment(::IceUtilInternal::Output&, const ContainedPtr&, const std::string&,
                                    const std::string& = "");
        ...
        static void writeDocCommentAsync(::IceUtilInternal::Output&, const OperationPtr&, ParamDir,
                                         const std::string& = "");
        static void writeDocCommentAMI(::IceUtilInternal::Output&, const OperationPtr&, ParamDir,
    ...
    {
    public:
        GenCompat(const std::string&, const std::string&, const std::vector<std::string>&, const std::string&, bool);
        ~GenCompat();
