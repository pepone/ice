...
public:
    ...
    getServerProxyAsync(::std::function<void(::std::shared_ptr<ObjectPrx>)> response,
                        ...
                        const Context& context = noExplicitContext)
    {
        return _makeLamdaOutgoing<::std::shared_ptr<ObjectPrx>>(response, ex, sent, this, &Ice::RouterPrx::_iceI_getServerProxy, context);
    }
    ...
    addProxiesAsync(const ObjectProxySeq& proxies,
                    ...
                    const Context& context = noExplicitContext)
    {
        return _makeLamdaOutgoing<ObjectProxySeq>(response, ex, sent, this, &Ice::RouterPrx::_iceI_addProxies, proxies, context);
    }
...
public:
    ...
    getRouterAsync(::std::function<void(::std::shared_ptr<RouterPrx>)> response,
                   ...
                   const Context& context = noExplicitContext)
    {
        return _makeLamdaOutgoing<::std::shared_ptr<RouterPrx>>(response, ex, sent, this, &Ice::RouterFinderPrx::_iceI_getRouter, context);
    }
