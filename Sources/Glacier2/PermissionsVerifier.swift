...
public extension PermissionsVerifierPrx {
    ...
    func checkPermissionsAsync(userId iceP_userId: Swift.String, password iceP_password: Swift.String, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<(returnValue: Swift.Bool, reason: Swift.String)> {
...
public extension SSLPermissionsVerifierPrx {
    ...
    ///
    /// - returns: `PromiseKit.Promise<(returnValue: Swift.Bool, reason: Swift.String)>` - The result of the operation
    func authorizeAsync(_ iceP_info: SSLInfo, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<(returnValue: Swift.Bool, reason: Swift.String)> {
...
public struct PermissionsVerifierDisp: Ice.Disp {
    ...
    public func dispatch(request: Ice.Request, current: Ice.Current) throws {
        ...
        case "checkPermissions":
            try servant._iceD_checkPermissions(incoming: request, current: current)
        case "ice_id":
            try (servant as? Object ?? PermissionsVerifierDisp.defaultObject)._iceD_ice_id(incoming: request, current: current)
        case "ice_ids":
            try (servant as? Object ?? PermissionsVerifierDisp.defaultObject)._iceD_ice_ids(incoming: request, current: current)
        case "ice_isA":
            try (servant as? Object ?? PermissionsVerifierDisp.defaultObject)._iceD_ice_isA(incoming: request, current: current)
        case "ice_ping":
            try (servant as? Object ?? PermissionsVerifierDisp.defaultObject)._iceD_ice_ping(incoming: request, current: current)
        default:
...
public struct SSLPermissionsVerifierDisp: Ice.Disp {
    ...
    public func dispatch(request: Ice.Request, current: Ice.Current) throws {
        switch current.operation {
        case "authorize":
            try servant._iceD_authorize(incoming: request, current: current)
        case "ice_id":
            try (servant as? Object ?? SSLPermissionsVerifierDisp.defaultObject)._iceD_ice_id(incoming: request, current: current)
        case "ice_ids":
            try (servant as? Object ?? SSLPermissionsVerifierDisp.defaultObject)._iceD_ice_ids(incoming: request, current: current)
        case "ice_isA":
            try (servant as? Object ?? SSLPermissionsVerifierDisp.defaultObject)._iceD_ice_isA(incoming: request, current: current)
        case "ice_ping":
            try (servant as? Object ?? SSLPermissionsVerifierDisp.defaultObject)._iceD_ice_ping(incoming: request, current: current)
        default:
            throw Ice.OperationNotExistException(id: current.id, facet: current.facet, operation: current.operation)
        }
    }
...
public extension PermissionsVerifier {
    func _iceD_checkPermissions(incoming inS: Ice.Incoming, current: Ice.Current) throws {
...
public extension SSLPermissionsVerifier {
    func _iceD_authorize(incoming inS: Ice.Incoming, current: Ice.Current) throws {
