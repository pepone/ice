...
public extension RouterPrx {
    ...
    func getCategoryForClientAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.String> {
    ...
    func refreshSessionAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func destroySessionAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
    ...
    func getSessionTimeoutAsync(context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Int64> {
...
public struct RouterDisp: Ice.Disp {
    ...
    public func dispatch(request: Ice.Request, current: Ice.Current) throws {
        ...
        case "destroySession":
            try servant._iceD_destroySession(incoming: request, current: current)
        case "getACMTimeout":
            try servant._iceD_getACMTimeout(incoming: request, current: current)
        case "getCategoryForClient":
            try servant._iceD_getCategoryForClient(incoming: request, current: current)
        case "getClientProxy":
        ...
        case "refreshSession":
            try servant._iceD_refreshSession(incoming: request, current: current)
        default:
...
public extension Router {
    func _iceD_getCategoryForClient(incoming inS: Ice.Incoming, current: Ice.Current) throws {
    ...
    func _iceD_createSession(incoming inS: Ice.Incoming, current: Ice.Current) throws {
        ...
        firstly {
            createSessionAsync(userId: iceP_userId, password: iceP_password, current: current)
    ...
    func _iceD_createSessionFromSecureConnection(incoming inS: Ice.Incoming, current: Ice.Current) throws {
        ...
        firstly {
            createSessionFromSecureConnectionAsync(current: current)
        }.done(on: nil) { iceP_returnValue in
            inS.write { ostr in
                ostr.write(iceP_returnValue)
            }
    ...
    func _iceD_refreshSession(incoming inS: Ice.Incoming, current: Ice.Current) throws {
        try inS.readEmptyParams()

        firstly {
            refreshSessionAsync(current: current)
        }.done(on: nil) {
    ...
    func _iceD_destroySession(incoming inS: Ice.Incoming, current: Ice.Current) throws {
        try inS.readEmptyParams()
