...
public extension SessionPrx {
    ...
    func allocateObjectByIdAsync(_ iceP_id: Ice.Identity, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Ice.ObjectPrx?> {
    ...
    ///
    /// - returns: `PromiseKit.Promise<Ice.ObjectPrx?>` - The result of the operation
    func allocateObjectByTypeAsync(_ iceP_type: Swift.String, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Ice.ObjectPrx?> {
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func releaseObjectAsync(_ iceP_id: Ice.Identity, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func setAllocationTimeoutAsync(_ iceP_timeout: Swift.Int32, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
...
public struct SessionDisp: Ice.Disp {
    ...
    public func dispatch(request: Ice.Request, current: Ice.Current) throws {
        ...
        case "allocateObjectById":
            try servant._iceD_allocateObjectById(incoming: request, current: current)
        case "allocateObjectByType":
            try servant._iceD_allocateObjectByType(incoming: request, current: current)
        case "destroy":
        ...
        case "releaseObject":
            try servant._iceD_releaseObject(incoming: request, current: current)
        case "setAllocationTimeout":
            try servant._iceD_setAllocationTimeout(incoming: request, current: current)
        default:
...
public extension Session {
    ...
    func _iceD_allocateObjectById(incoming inS: Ice.Incoming, current: Ice.Current) throws {
        ...
        firstly {
            allocateObjectByIdAsync(id: iceP_id, current: current)
    ...
    func _iceD_allocateObjectByType(incoming inS: Ice.Incoming, current: Ice.Current) throws {
        ...
        firstly {
            allocateObjectByTypeAsync(type: iceP_type, current: current)
        }.done(on: nil) { iceP_returnValue in
            inS.write { ostr in
                ostr.write(iceP_returnValue)
            }
    ...
    func _iceD_releaseObject(incoming inS: Ice.Incoming, current: Ice.Current) throws {
        let iceP_id: Ice.Identity = try inS.read { istr in
            let iceP_id: Ice.Identity = try istr.read()
            return iceP_id
        }
    ...
    func _iceD_setAllocationTimeout(incoming inS: Ice.Incoming, current: Ice.Current) throws {
