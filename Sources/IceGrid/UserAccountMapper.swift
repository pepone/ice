...
public extension UserAccountMapperPrx {
    ...
    func getUserAccountAsync(_ iceP_user: Swift.String, context: Ice.Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.String> {
...
public struct UserAccountMapperDisp: Ice.Disp {
    ...
    public func dispatch(request: Ice.Request, current: Ice.Current) throws {
        ...
        case "getUserAccount":
            try servant._iceD_getUserAccount(incoming: request, current: current)
        case "ice_id":
            try (servant as? Object ?? UserAccountMapperDisp.defaultObject)._iceD_ice_id(incoming: request, current: current)
        case "ice_ids":
            try (servant as? Object ?? UserAccountMapperDisp.defaultObject)._iceD_ice_ids(incoming: request, current: current)
        case "ice_isA":
            try (servant as? Object ?? UserAccountMapperDisp.defaultObject)._iceD_ice_isA(incoming: request, current: current)
        case "ice_ping":
            try (servant as? Object ?? UserAccountMapperDisp.defaultObject)._iceD_ice_ping(incoming: request, current: current)
        default:
...
public extension UserAccountMapper {
    func _iceD_getUserAccount(incoming inS: Ice.Incoming, current: Ice.Current) throws {
