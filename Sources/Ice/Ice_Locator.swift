...
public extension LocatorPrx {
    ...
    func findObjectByIdAsync(_ iceP_id: Identity, context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<ObjectPrx?> {
    ...
    ///
    /// - returns: `PromiseKit.Promise<ObjectPrx?>` - The result of the operation
    func findAdapterByIdAsync(_ iceP_id: Swift.String, context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<ObjectPrx?> {
    ...
    func getRegistryAsync(context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<LocatorRegistryPrx?> {
...
public extension LocatorRegistryPrx {
    ...
    func setAdapterDirectProxyAsync(id iceP_id: Swift.String, proxy iceP_proxy: ObjectPrx?, context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func setReplicatedAdapterDirectProxyAsync(adapterId iceP_adapterId: Swift.String, replicaGroupId iceP_replicaGroupId: Swift.String, p iceP_p: ObjectPrx?, context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func setServerProcessProxyAsync(id iceP_id: Swift.String, proxy iceP_proxy: ProcessPrx?, context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
...
public extension LocatorFinderPrx {
    ...
    func getLocatorAsync(context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<LocatorPrx?> {
...
public struct LocatorRegistryDisp: Disp {
    ...
    public func dispatch(request: Request, current: Current) throws {
        switch current.operation {
        case "ice_id":
            try (servant as? Object ?? LocatorRegistryDisp.defaultObject)._iceD_ice_id(incoming: request, current: current)
        case "ice_ids":
            try (servant as? Object ?? LocatorRegistryDisp.defaultObject)._iceD_ice_ids(incoming: request, current: current)
        case "ice_isA":
            try (servant as? Object ?? LocatorRegistryDisp.defaultObject)._iceD_ice_isA(incoming: request, current: current)
        case "ice_ping":
            try (servant as? Object ?? LocatorRegistryDisp.defaultObject)._iceD_ice_ping(incoming: request, current: current)
        case "setAdapterDirectProxy":
            try servant._iceD_setAdapterDirectProxy(incoming: request, current: current)
        case "setReplicatedAdapterDirectProxy":
            try servant._iceD_setReplicatedAdapterDirectProxy(incoming: request, current: current)
        case "setServerProcessProxy":
            try servant._iceD_setServerProcessProxy(incoming: request, current: current)
        default:
            throw OperationNotExistException(id: current.id, facet: current.facet, operation: current.operation)
        }
    }
...
public struct LocatorFinderDisp: Disp {
    ...
    public func dispatch(request: Request, current: Current) throws {
        switch current.operation {
        case "getLocator":
            try servant._iceD_getLocator(incoming: request, current: current)
        case "ice_id":
            try (servant as? Object ?? LocatorFinderDisp.defaultObject)._iceD_ice_id(incoming: request, current: current)
        case "ice_ids":
            try (servant as? Object ?? LocatorFinderDisp.defaultObject)._iceD_ice_ids(incoming: request, current: current)
        case "ice_isA":
            try (servant as? Object ?? LocatorFinderDisp.defaultObject)._iceD_ice_isA(incoming: request, current: current)
        case "ice_ping":
            try (servant as? Object ?? LocatorFinderDisp.defaultObject)._iceD_ice_ping(incoming: request, current: current)
        default:
            throw OperationNotExistException(id: current.id, facet: current.facet, operation: current.operation)
        }
    }
...
public extension Locator {
    func _iceD_findObjectById(incoming inS: Incoming, current: Current) throws {
        ...
        firstly {
            findObjectByIdAsync(id: iceP_id, current: current)
    ...
    func _iceD_findAdapterById(incoming inS: Incoming, current: Current) throws {
        ...
        firstly {
            findAdapterByIdAsync(id: iceP_id, current: current)
        }.done(on: nil) { iceP_returnValue in
            inS.write { ostr in
                ostr.write(iceP_returnValue)
            }
    ...
    func _iceD_getRegistry(incoming inS: Incoming, current: Current) throws {
...
public extension LocatorRegistry {
    func _iceD_setAdapterDirectProxy(incoming inS: Incoming, current: Current) throws {
        ...
        firstly {
            setAdapterDirectProxyAsync(id: iceP_id, proxy: iceP_proxy, current: current)
        }.done(on: nil) {
    ...
    func _iceD_setReplicatedAdapterDirectProxy(incoming inS: Incoming, current: Current) throws {
        ...
        firstly {
            setReplicatedAdapterDirectProxyAsync(adapterId: iceP_adapterId, replicaGroupId: iceP_replicaGroupId, p: iceP_p, current: current)
        }.done(on: nil) {
            inS.writeEmptyParams()
        }.catch(on: nil) { err in
            inS.exception(err)
    ...
    func _iceD_setServerProcessProxy(incoming inS: Incoming, current: Current) throws {
        ...
        firstly {
            setServerProcessProxyAsync(id: iceP_id, proxy: iceP_proxy, current: current)
        }.done(on: nil) {
            inS.writeEmptyParams()
        }.catch(on: nil) { err in
            inS.exception(err)
...
public extension LocatorFinder {
    func _iceD_getLocator(incoming inS: Incoming, current: Current) throws {
        try inS.readEmptyParams()
