...
public extension ProcessPrx {
    ...
    func shutdownAsync(context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func writeMessageAsync(message iceP_message: Swift.String, fd iceP_fd: Swift.Int32, context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
...
public struct ProcessDisp: Disp {
    ...
    public func dispatch(request: Request, current: Current) throws {
        ...
        case "ice_id":
            try (servant as? Object ?? ProcessDisp.defaultObject)._iceD_ice_id(incoming: request, current: current)
        case "ice_ids":
            try (servant as? Object ?? ProcessDisp.defaultObject)._iceD_ice_ids(incoming: request, current: current)
        case "ice_isA":
            try (servant as? Object ?? ProcessDisp.defaultObject)._iceD_ice_isA(incoming: request, current: current)
        case "ice_ping":
            try (servant as? Object ?? ProcessDisp.defaultObject)._iceD_ice_ping(incoming: request, current: current)
        case "shutdown":
            try servant._iceD_shutdown(incoming: request, current: current)
        case "writeMessage":
            try servant._iceD_writeMessage(incoming: request, current: current)
        default:
...
public extension Process {
    func _iceD_shutdown(incoming inS: Incoming, current: Current) throws {
    ...
    func _iceD_writeMessage(incoming inS: Incoming, current: Current) throws {
