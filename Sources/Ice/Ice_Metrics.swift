...
public struct MXMetricsMapHelper {
    ...
    public static func read(from istr: InputStream) throws -> MXMetricsMap {
        ...
        for i in 0 ..< sz {
            let p = UnsafeMutablePointer<MXMetrics?>(&v[i])
...
public extension MXMetricsAdminPrx {
    ...
    func getMetricsViewNamesAsync(context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<(returnValue: StringSeq, disabledViews: StringSeq)> {
    ...
    func enableMetricsViewAsync(_ iceP_name: Swift.String, context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func disableMetricsViewAsync(_ iceP_name: Swift.String, context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
    ...
    func getMetricsViewAsync(_ iceP_view: Swift.String, context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<(returnValue: MXMetricsView, timestamp: Swift.Int64)> {
    ...
    func getMapMetricsFailuresAsync(view iceP_view: Swift.String, map iceP_map: Swift.String, context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<MXMetricsFailuresSeq> {
    ...
    func getMetricsFailuresAsync(view iceP_view: Swift.String, map iceP_map: Swift.String, id iceP_id: Swift.String, context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<MXMetricsFailures> {
...
public struct MXMetricsAdminDisp: Disp {
    ...
    public func dispatch(request: Request, current: Current) throws {
        ...
        case "disableMetricsView":
            try servant._iceD_disableMetricsView(incoming: request, current: current)
        case "enableMetricsView":
            try servant._iceD_enableMetricsView(incoming: request, current: current)
        case "getMapMetricsFailures":
            try servant._iceD_getMapMetricsFailures(incoming: request, current: current)
        case "getMetricsFailures":
            try servant._iceD_getMetricsFailures(incoming: request, current: current)
        case "getMetricsView":
            try servant._iceD_getMetricsView(incoming: request, current: current)
        case "getMetricsViewNames":
            try servant._iceD_getMetricsViewNames(incoming: request, current: current)
        case "ice_id":
            try (servant as? Object ?? MXMetricsAdminDisp.defaultObject)._iceD_ice_id(incoming: request, current: current)
        case "ice_ids":
            try (servant as? Object ?? MXMetricsAdminDisp.defaultObject)._iceD_ice_ids(incoming: request, current: current)
        case "ice_isA":
            try (servant as? Object ?? MXMetricsAdminDisp.defaultObject)._iceD_ice_isA(incoming: request, current: current)
        case "ice_ping":
            try (servant as? Object ?? MXMetricsAdminDisp.defaultObject)._iceD_ice_ping(incoming: request, current: current)
        default:
...
public extension MXMetricsAdmin {
    func _iceD_getMetricsViewNames(incoming inS: Incoming, current: Current) throws {
    ...
    func _iceD_enableMetricsView(incoming inS: Incoming, current: Current) throws {
    ...
    func _iceD_disableMetricsView(incoming inS: Incoming, current: Current) throws {
        let iceP_name: Swift.String = try inS.read { istr in
            let iceP_name: Swift.String = try istr.read()
            return iceP_name
        }
    ...
    func _iceD_getMetricsView(incoming inS: Incoming, current: Current) throws {
    ...
    func _iceD_getMapMetricsFailures(incoming inS: Incoming, current: Current) throws {
    ...
    func _iceD_getMetricsFailures(incoming inS: Incoming, current: Current) throws {
