...
public extension RemoteLoggerPrx {
    ...
    func initAsync(prefix iceP_prefix: Swift.String, logMessages iceP_logMessages: LogMessageSeq, context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func logAsync(_ iceP_message: LogMessage, context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
...
public extension LoggerAdminPrx {
    ...
    ///
    /// - returns: `PromiseKit.Promise<>` - The result of the operation
    func attachRemoteLoggerAsync(prx iceP_prx: RemoteLoggerPrx?, messageTypes iceP_messageTypes: LogMessageTypeSeq, traceCategories iceP_traceCategories: StringSeq, messageMax iceP_messageMax: Swift.Int32, context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
    ...
    func detachRemoteLoggerAsync(_ iceP_prx: RemoteLoggerPrx?, context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Bool> {
    ...
    func getLogAsync(messageTypes iceP_messageTypes: LogMessageTypeSeq, traceCategories iceP_traceCategories: StringSeq, messageMax iceP_messageMax: Swift.Int32, context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<(returnValue: LogMessageSeq, prefix: Swift.String)> {
...
public struct RemoteLoggerDisp: Disp {
    ...
    public func dispatch(request: Request, current: Current) throws {
        ...
        case "ice_id":
            try (servant as? Object ?? RemoteLoggerDisp.defaultObject)._iceD_ice_id(incoming: request, current: current)
        case "ice_ids":
            try (servant as? Object ?? RemoteLoggerDisp.defaultObject)._iceD_ice_ids(incoming: request, current: current)
        case "ice_isA":
            try (servant as? Object ?? RemoteLoggerDisp.defaultObject)._iceD_ice_isA(incoming: request, current: current)
        case "ice_ping":
            try (servant as? Object ?? RemoteLoggerDisp.defaultObject)._iceD_ice_ping(incoming: request, current: current)
        case "init":
            try servant._iceD_init(incoming: request, current: current)
        case "log":
            try servant._iceD_log(incoming: request, current: current)
        default:
...
public struct LoggerAdminDisp: Disp {
    ...
    public func dispatch(request: Request, current: Current) throws {
        ...
        case "attachRemoteLogger":
            try servant._iceD_attachRemoteLogger(incoming: request, current: current)
        case "detachRemoteLogger":
            try servant._iceD_detachRemoteLogger(incoming: request, current: current)
        case "getLog":
            try servant._iceD_getLog(incoming: request, current: current)
        case "ice_id":
            try (servant as? Object ?? LoggerAdminDisp.defaultObject)._iceD_ice_id(incoming: request, current: current)
        case "ice_ids":
            try (servant as? Object ?? LoggerAdminDisp.defaultObject)._iceD_ice_ids(incoming: request, current: current)
        case "ice_isA":
            try (servant as? Object ?? LoggerAdminDisp.defaultObject)._iceD_ice_isA(incoming: request, current: current)
        case "ice_ping":
            try (servant as? Object ?? LoggerAdminDisp.defaultObject)._iceD_ice_ping(incoming: request, current: current)
        default:
            throw OperationNotExistException(id: current.id, facet: current.facet, operation: current.operation)
        }
    }
...
public extension RemoteLogger {
    func _iceD_init(incoming inS: Incoming, current: Current) throws {
    ...
    func _iceD_log(incoming inS: Incoming, current: Current) throws {
...
public extension LoggerAdmin {
    func _iceD_attachRemoteLogger(incoming inS: Incoming, current: Current) throws {
    ...
    func _iceD_detachRemoteLogger(incoming inS: Incoming, current: Current) throws {
    ...
    func _iceD_getLog(incoming inS: Incoming, current: Current) throws {
