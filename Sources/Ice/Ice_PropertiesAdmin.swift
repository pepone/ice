...
public extension PropertiesAdminPrx {
    ...
    func getPropertyAsync(_ iceP_key: Swift.String, context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.String> {
    ...
    func getPropertiesForPrefixAsync(_ iceP_prefix: Swift.String, context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<PropertyDict> {
    ...
    func setPropertiesAsync(_ iceP_newProperties: PropertyDict, context: Context? = nil, sentOn: Dispatch.DispatchQueue? = PromiseKit.conf.Q.return, sentFlags: Dispatch.DispatchWorkItemFlags? = nil, sent: ((Swift.Bool) -> Swift.Void)? = nil) -> PromiseKit.Promise<Swift.Void> {
...
public struct PropertiesAdminDisp: Disp {
    ...
    public func dispatch(request: Request, current: Current) throws {
        ...
        case "getPropertiesForPrefix":
            try servant._iceD_getPropertiesForPrefix(incoming: request, current: current)
        case "getProperty":
            try servant._iceD_getProperty(incoming: request, current: current)
        case "ice_id":
            try (servant as? Object ?? PropertiesAdminDisp.defaultObject)._iceD_ice_id(incoming: request, current: current)
        case "ice_ids":
            try (servant as? Object ?? PropertiesAdminDisp.defaultObject)._iceD_ice_ids(incoming: request, current: current)
        case "ice_isA":
            try (servant as? Object ?? PropertiesAdminDisp.defaultObject)._iceD_ice_isA(incoming: request, current: current)
        case "ice_ping":
            try (servant as? Object ?? PropertiesAdminDisp.defaultObject)._iceD_ice_ping(incoming: request, current: current)
        case "setProperties":
            try servant._iceD_setProperties(incoming: request, current: current)
        default:
...
public extension PropertiesAdmin {
    func _iceD_getProperty(incoming inS: Incoming, current: Current) throws {
    ...
    func _iceD_getPropertiesForPrefix(incoming inS: Incoming, current: Current) throws {
    ...
    func _iceD_setProperties(incoming inS: Incoming, current: Current) throws {
